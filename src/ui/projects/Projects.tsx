                ...
                <div className="max-w-sm bg-white border border-gray-200 rounded-xl shadow" key={project.title}>
                    ...
                    <div className="p-5">
                        ...
                        <div className="relative inline-flex group">
                            <div
                                className={`absolute transition-all duration-1000 opacity-70 -inset-px bg-${project.color} rounded-xl blur-lg group-hover:opacity-100 group-hover:-inset-1 group-hover:duration-200 animate-tilt`}>
                            </div>

                            <a href="" className={`relative inline-flex items-center justify center px-4 py-2 transition-all duration-200 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg hover:bg-gray-100 hover:text-${project.color} focus:z-10 focus:ring-4 focus:outline-none focus:ring-gray-500 focus:text-${project.color}`}>Read more<svg className="w-3 h-3 ms-2 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
